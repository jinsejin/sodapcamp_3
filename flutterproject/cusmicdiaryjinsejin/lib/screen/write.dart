            ...
            onPressed: () {
              showDialog(
                  ...
                  builder: (BuildContext) {
                    return const ShowDialoginSending();
                  });
            },
          ),
          backgroundColor: const Color(0xff0A0028),
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: const Padding(
        ...
        child: Text(
          '일기를 보내시겠습니까?',
          style: TextStyle(fontFamily: 'Lotte', color: Colors.black),
        ),
      ),
      ...
      actions: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xff8C8F93)),
          ),
          child: TextButton(
            ...
            child: const Text(
              '취소',
              style: TextStyle(fontFamily: 'Lotte', color: Color(0xff8C8F93)),
            ),
            onPressed: () {
        ...
        Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(21.5),
            border: Border.all(color: const Color(0xffD66ED1)),
          ),
          child: TextButton(
            style: TextButton.styleFrom(
              textStyle: Theme.of(context).textTheme.labelLarge,
            ...
            child: const Text(
              '보내기',
              style: TextStyle(fontFamily: 'Lotte', color: Color(0xffD66ED1)),
            ),
            onPressed: () async {
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(nowdatetime,
              style: fontboldmiddle, textAlign: TextAlign.center),
        ),
        const Camerapart(),
        const Wirtecontent(),
      ],
